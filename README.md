...
*Suggest and discuss possible enhancements on the [Potential Additions](https://github.com/coree/awesome-rag/discussions/1) ⭐ 433 | 🐛 21 | 📅 2025-12-01 page.*
...
* **Kiln**\
  *Open-source application to build and evaluate production-ready RAG pipelines.*\
  [`Website`](https://kiln.tech) [`GitHub`](https://github.com/Kiln-AI/Kiln) ⭐ 5,078 | 🐛 72 | 🌐 Python | 📅 2026-09-20
